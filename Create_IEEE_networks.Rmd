...
rep <-5
alpha_vector <- c(1, 1.02, 1.01, 1.005, 1.05, 1.1, 1.2, 1.5, 2, 3, 5, 7, 10, 15, 20, 50, 100, 200, Inf)#[c(0,6,12)+rep]
alpha_vector
set.seed(21256)
...
#Create the simulations for each of the alpha values using 100 simulations for each
alpha_vector %>% walk(~{
