...
list.files("/home/jonno/HPC_jobs/UK_high_voltage", pattern = ".tgz", full.names = T) %>% 
  walk(~{
  untar(tarfile =.x, 
        exdir = "/home/jonno/Dropbox/IEEE_Networks/attacks",#, 
        extras = "--strip-components 4"  #take only the useful bits of the zip file
...
```{r}
list.files("/home/jonno/test_strain/IEEE_118_igraph_strain_rc_alt/IEEE_118_igraph_raw", 
           pattern = ".tgz", full.names = T) %>% 
  walk(~{
  untar(tarfile =.x, 
        exdir = "/home/jonno/test_strain/IEEE_118_igraph_strain_rc_alt",#, 
        extras = "--strip-components 4"  #take only the useful bits of the zip file
      )})
...
```{r}
"/home/jonno/test_strain/IEEE_118_igraph_strain_rc_alt/IEEE_118_igraph/IEEE_118_igraph"
...
#saveRDS(test_rc_metrics, "/home/jonno/test_strain/IEEE_118_igraph_strain_rc_alt/rc_alt_metrics_df.rds")

test_rc_metrics <-read_rds("/home/jonno/test_strain/IEEE_118_strainrc/rc_metrics_df.rds")

table(test_rc_metrics$static_force>0.002)

test <- IEEE_118_agg_res %>%
  #mutate(mean_alpha = 1/mean_alpha) %>%
