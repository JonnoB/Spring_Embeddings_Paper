...
```{r}
microbenchmark(test1 =auto_SETS(current_graph, 
           force ="net_generation", 
           flow = "power_flow", 
           distance = "distance", 
           edge_name = "edge_name",
...
test2 = auto_SETS2(current_graph, 
           force ="net_generation", 
           flow = "power_flow", 
           distance = "distance", 
           edge_name = "edge_name",
...
profvis(auto_SETS(current_graph, 
           force ="net_generation", 
           flow = "power_flow", 
           distance = "distance", 
           edge_name = "edge_name",
...
memory_df %>%
  ...
  ggplot(aes(y = log10(res_stat), x = (common_drag_iter))) + geom_line()
...
for(i in rev(c(30, 57))){
  
  task_id <-  1#this is the compute group to be used
  
  load_file <- paste0("IEEE_",i ,"_igraph")
  
  source(file.path("/home/jonno/setse_and_network_robustness/HPC_files/HPC_files_concentrator", "HPC_strain_autoconverge_script.R"), local = TRUE)
}
