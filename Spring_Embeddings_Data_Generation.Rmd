...
c(power_grid_graphs_path, collapse_sets, collapse_set_summaries, permuted_IEEE_118_path, edge_scramble_keys_path, edge_scramble_keys_IEEE_permutation_path, analysis_parameter_file_path) %>% walk(~{
...
saveRDS(parameter_df, file.path(analysis_parameter_file_path, "base_parameter_file.rds"))
```
...
unique(parameter_df$graph_path) %>% walk(~{
  ...
  saveRDS(temp, file.path(analysis_parameter_file_path, file_name))  
