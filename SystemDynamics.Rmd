...
##########
peel_strain_sum %>%
  ggplot(aes(x = sd_strain, y = mean, colour = Network)) + geom_point() +
  labs(title = "Seperating Peel's quintet using embedded height and strain",
       x = "Standard deviation of edge strain",
